  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setExperiencia('');
        setComentarios('');
        setEntornoDesarrollo('');
        setHerramientasRecursos('');
        setCumplimientoEstandares('');
        setPruebasControlCalidad('');
        setColaboracionComunicacion('');
        setSatisfaccionDesarrollo('');
        setComentariosDesarrollo('');
        setInsterfazUsuario('');
        setExperienciaUsuario('');
        setOptimizacionRendimiento('');
        setTiempoCarga('');
        setFeedbackComunicacion('');
        setSatisfaccionMejoras('');
        setComentariosMejoras('');
        setFacilidadReportes('');
        setVariedadReporte('');
        setPersonalizacionReportes('');
        setFormatoReportes('');
        setFrecuenciaReportes('');
        setSatisfaccionReportes('');
        setComentariosReportes('');
        setTiempoRespuesta('');
        setEficienciaResolucion('');
        setCalidadSoporte('');
        setDisponibilidadSoporte('');
        setComunicacionProceso('');
        setSatisfaccionSoporte('');
        setComentariosSoporte('');
        setSeguridadAplicacion('');
        setProteccionInfoPersonal('');
        setSeguridadAuthAcceso('');
        setEncriptacionDatos('');
        setManejoSeguridad('');
        setPoliticaPrivTransparencia('');
        setConcienciacionSeguridad('');
        setSatisfacionGeneralSeguridad('');
        setComentariosSeguridad('');
        setDisponibilidadRecursoAprendizaje('');
        setClaridadTutorial('');
        setUtilidadTutorial('');
        setFormatoRecurso('');
        setAccesibilidadRecurso('');
        setFrecuenciaActTutorial('');
        setSatisfaccionRecursoAprendizaje('');
        setComentariosAprendizaje('');
